...
function Projects() {
    ...
    return (
        <Project id='projects' >
            ...
            <BoxProject>
            <ProjectItens template={systemFinance} name = 'Finance' projeto = 'https://rffinancialsystem.netlify.app/' description= 'O Sistema de Finanças é um projeto que desenvolvi com o objetivo de aprimorar meus conhecimentos em React e JavaScript. O projeto tem como finalidade ajudar na organização das finanças pessoais, permitindo que o usuário adicione entradas e saídas de valores, e o sistema realiza o cálculo das transações realizadas, exibindo o total de saldo, total de saídas e total de entradas.' icon1={<FaReact/>} icon2={<SiJavascript/>} icon3={<SiStyledcomponents/>} />
