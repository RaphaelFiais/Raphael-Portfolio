...
function Projects() {
    ...
    return (
        <Project id='projects' >
            ...
            <ProjectItens template={drAndreaSandriny} name = 'Dr Andrea Sandriny' projeto='https://draandreasandriny.com.br/' description = 'O site institucional da Dr Andrea foi feito com Wordpress e Elementor. A página apresenta a Doutora e alguns serviços com o design simples, interativo e moderno.' icon1={<SiWordpress/>} icon2={<FaElementor/>}/>
            <ProjectItens template={lavaMax} name = 'Lavamax Lavanderias' projeto = 'http://lavmaxlavanderia.com.br/' description= 'O site institucional do LavaMax Lavanderias foi feito com Wordpress e Elementor. Com o design simples, interativo e moderno, a página apresenta o ambiente de trabalho e alguns serviços.' icon1={<SiWordpress/>} icon2={<FaElementor/>} />
            </BoxProject>
        </Project>
    )
}
